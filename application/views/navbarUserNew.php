  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a style="margin-left:22px" float class="navbar-brand" href="#">
        <img src="<?php echo base_url(); ?>application/views/img/home-128.png" width="28" height="28"></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a style="font-size:16px" href="#" data-toggle="dropdown">ใช้บริการรถภายนอก <span class="sr-only">(current)</span></a></li>
        <li><a style="font-size:16px"href="#" data-toggle="dropdown">ดูประวัติการใช้บริการรถ</a></li>
        <li class="dropdown">
