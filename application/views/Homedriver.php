...
<body >
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="<?php echo base_url();?>Reserve/add_dateS" method="POST" id="formSaveDateS" class="form-horizontal">
						...
						<button type="submit" id="btnSave" class="btn btn-primary disabled toggle3" disabled>ยืนยัน</button>
				...
				<div class="modal-content">
					<form action="<?php echo base_url();?>Reserve/add_dateE" method="POST" id="formEdit" class="form-horizontal">
						...
						<div class="modal-footer">
							...
							<button type="submit" id="btnSave" class="btn btn-primary disabled toggle2" disabled>ยืนยัน</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						</div>
					</form>
				...
				<div class="modal-content">
					...
					<form action="<?php echo base_url();?>Driver/save_Transaction" method="POST" id="formSaveTrans" >	
						...
						<div class="modal-footer">
							...
							<button type="submit" id="btnSave" class="btn btn-primary disabled toggle" disabled>ยืนยัน</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	...
	function check() {
		...
		x[0].classList.toggle('disabled');

		if(x[0].disabled = true){
			x[0].disabled = false;
		}else if(x[0].disabled = false){
			x[0].disabled =true;
		}		
	}

	function check2() {
		var x = document.getElementsByClassName("toggle2");
	...
	function check3() {
		var x = document.getElementsByClassName("toggle3");
